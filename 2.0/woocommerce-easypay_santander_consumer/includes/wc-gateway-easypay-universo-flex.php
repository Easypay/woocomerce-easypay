...
class WC_Gateway_Easypay_Universo_Flex extends WC_Payment_Gateway
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->ahref = '<a href="' . get_admin_url() . 'admin.php?' .
            'page=wc-settings&amp;' .
            'tab=checkout&amp;' .
            'section=wc_payment_gateway_easypay_universo_flex">';
        $this->a = '</a>';
        ...
        // Inherited Variables----------------------------------------------
        $this->id = 'easypay_universo_flex';
        $this->icon = plugins_url('../images/logo.png', __FILE__);
        $this->has_fields = false;
        $this->method_title = __('Easypay Universo Flex', 'wceasypay');
    ...
    */
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'title'       => [
                ...
                'default'     => __('Easypay Universo Flex', 'wceasypay'),
                'desc_tip'    => true,
            ],
            'description' => [
    ...
    public function admin_options()
    {
        ...
        <table class="form-table">
            ...
            <tr>
                <td>
                    <h4><?= __('Universo Flex - Fwd URL', 'wceasypay') ?></h4>
                </td>
                <td>
                    <input value="<?= $public_url ?>universo-flex-fwd.php" type="text" size="100" readonly>
                </td>
            </tr>
            <tr>
                <td>
                    <h4><?= __('Universo Flex - Detail URL', 'wceasypay') ?></h4>
                </td>
                <td>
                    <input value="<?= $public_url ?>universo-flex-detail.php" type="text" size="100" readonly>
                </td>
            </tr>
        </table>
        <?php
    ...
    public function generate_form($order_id)
    {
        ...
        if ($data['status'] != 'ok') {
            ...
            $note = __('Awaiting for Universo Flex payment.', 'wceasypay') . PHP_EOL;
