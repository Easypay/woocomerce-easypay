...
class WC_Gateway_Easypay_Santander_Consumer extends WC_Payment_Gateway
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->ahref = '<a href="' . get_admin_url() . 'admin.php?' .
            'page=wc-settings&amp;' .
            'tab=checkout&amp;' .
            'section=wc_payment_gateway_easypay_santander_consumer">';
        $this->a = '</a>';
        ...
        // Inherited Variables----------------------------------------------
        $this->id = 'easypay_santander_consumer';
        $this->icon = plugins_url('../images/logo.png', __FILE__);
        $this->has_fields = false;
        $this->method_title = __('Easypay Santander Consumer', 'wceasypay');
    ...
    */
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'title'       => [
                ...
                'default'     => __('Easypay Santander Consumer', 'wceasypay'),
                'desc_tip'    => true,
            ],
            'description' => [
    ...
    public function generate_form($order_id)
    {
        ...
        if ($data['status'] != 'ok') {
            ...
            $note = __('Awaiting for santander consumer payment.', 'wceasypay') . PHP_EOL;
